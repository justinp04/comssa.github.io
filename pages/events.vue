<template>
  <div class="events">
    ...
    <div class="event_info">
      <p>
        ComSSA regularly hosts events that everyone is welcome to attend.<br><br>
      ...
      <img id="event_image_1" src="~/assets/img/sundowner1.jpg">
      <img id="event_image_1" src="~/assets/img/sundowner.jpg">
    </div>
  </div>
</template>
<script>
